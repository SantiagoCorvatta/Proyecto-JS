...
const producto1 = new Producto("Camiseta River Plate 2022", "Futbol", 14.999, "../img/productos/river1ra.jpg")
producto1.propiedadArt()
const producto2 = new Producto("Camiseta Estudiantes de la Plata", "Futbol", 8.999, "../img/productos/estudiantes.jpg")
producto2.propiedadArt()
const producto3 = new Producto("Seleccion Argentina Hockey", "Hockey", 7.999, "../img/productos/leonas.jpg")
producto3.propiedadArt()
const producto4 = new Producto("Camiseta Seleccion Argentina Copa America", "Futbol", 12.999, "../img/productos/copaamerica.jpg")
producto4.propiedadArt()
const producto5 = new Producto("Los Angeles Lakers", "Basquet", 9.999, "../img/productos/lakers.jpg")
producto5.propiedadArt()
const producto6 = new Producto("Palo de Hockey Drial", "Hockey", 6.299, "../img/productos/drial.jpg")
producto6.propiedadArt()
const producto7 = new Producto("Camiseta Independiente 2022", "Futbol", 7.999, "../img/productos/independiente.jpg")
producto7.propiedadArt()
const producto8 = new Producto("Camiseta Termica Flash", "Deportiva", 7.499, "../img/productos/termica.jpg")
producto8.propiedadArt()
const producto9 = new Producto("Camiseta Boca Juniors 2022", "Futbol", 14.999, "../img/productos/boca.jpg")
producto9.propiedadArt()
const producto10 = new Producto("Botines Puma Netfit", "Futbol", 8.999, "../img/productos/puma.jpg")
producto10.propiedadArt()
const producto11 = new Producto("Botines Total 90", "Futbol", 5.999, "../img/productos/total.jpg")
producto11.propiedadArt()
const producto12 = new Producto("Camiseta Seleccion Argentina 2022", "Futbol", 14.999, "../img/productos/argqatar.png")
producto12.propiedadArt()
const producto13 = new Producto("Chicago Bulls 23", "Basquet", 9.999, "../img/productos/bulls.png")
producto13.propiedadArt()
const producto14 = new Producto("Camiseta Seleccion Argentina '86", "Futbol", 7.499, "../img/productos/mexico86.jpg")
producto14.propiedadArt()
const producto15 = new Producto("Camiseta River Plate 2022 Alternativa", "Futbol", 12.999, "../img/productos/river2da.jpg")
producto15.propiedadArt()
const producto16 = new Producto("Camiseta Racing Club 2022", "Futbol", 7.999, "../img/productos/racing.jpg")
                                        ...
                                        <div class="wsk-cp-product">
                                            ...
                                            <div class="wsk-cp-text">
                                                ...
                                                <div class="card-footer">
                                                    ...
                                                    <div class="wcf-right"><a href="#" class="buy-btn"><img src="/img/cart.svg" alt=""></a></div>                
                                                </div>
                                            </div>
                                        </div>
                                    </div>
